...
Java_com_tks_videophotobook_VuforiaWrapperKt_initAR(JNIEnv *env, jclass claz,
                                                              jobject activity,
...
Java_com_tks_videophotobook_VuforiaWrapperKt_startAR(JNIEnv *env, jclass clazz) {
...
JNIEXPORT void JNICALL
Java_com_tks_videophotobook_VuforiaWrapperKt_stopAR(JNIEnv *env, jclass clazz) {
    controller.stopAR();
}


JNIEXPORT void JNICALL
Java_com_tks_videophotobook_VuforiaWrapperKt_deinitAR(JNIEnv *env, jclass clazz) {
    controller.deinitAR();
...
JNIEXPORT void JNICALL
Java_com_tks_videophotobook_VuforiaWrapperKt_cameraPerformAutoFocus(JNIEnv *env, jclass clazz) {
    controller.cameraPerformAutoFocus();
}


JNIEXPORT void JNICALL
Java_com_tks_videophotobook_VuforiaWrapperKt_cameraRestoreAutoFocus(JNIEnv *env, jclass clazz) {
    controller.cameraRestoreAutoFocus();
}


JNIEXPORT void JNICALL
Java_com_tks_videophotobook_VuforiaWrapperKt_initRendering(JNIEnv *env, jclass clazz) {
    // Define clear color
...
JNIEXPORT void JNICALL
Java_com_tks_videophotobook_VuforiaWrapperKt_deinitRendering(JNIEnv *env, jclass clazz) {
    gWrapperData.renderer.deinit();
}


JNIEXPORT jboolean JNICALL
Java_com_tks_videophotobook_VuforiaWrapperKt_configureRendering(JNIEnv *env, jclass clazz,
                                                                                     jint width,
                                                                                     jint height,
                                                                                     jint orientation,
                                                                                     jint rotation) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_tks_videophotobook_VuforiaWrapperKt_initVideoTexture(JNIEnv *env, jclass clazz) {
